...
export default function ReservationPage() {
  ...
  return (
    <div className="min-h-screen bg-warm-beige">
      {/* Header */}
      <header className="bg-gradient-to-r from-dark-green to-dark-green/95 text-white sticky top-0 z-40 shadow-lg">
                        ...
                        <Popover>
                          <PopoverTrigger asChild>
                            <Button
                              variant="outline"
                              className={cn(
                                "w-full justify-start text-left font-normal px-4 py-3 h-auto rounded-xl border-2 border-dark-green/20 hover:border-tomato-red",
