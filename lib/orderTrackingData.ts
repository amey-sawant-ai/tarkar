...
export const trackingOrders: OrderTracking[] = [
  {
    ...
    items: [
      { id: 1, name: "Paneer Butter Masala", quantity: 2, price: 280 },
      { id: 2, name: "Butter Naan", quantity: 4, price: 60 },
      { id: 3, name: "Dal Makhani", quantity: 1, price: 220 },
      { id: 4, name: "Jeera Rice", quantity: 2, price: 120 },
    ],
    subtotal: 680,
    tax: 34,
    deliveryFee: 40,
  ...
  },
  {
    ...
    items: [
      { id: 1, name: "Veg Biryani", quantity: 2, price: 380 },
      { id: 2, name: "Raita", quantity: 2, price: 80 },
      { id: 3, name: "Gulab Jamun", quantity: 4, price: 120 },
    ],
    subtotal: 580,
    tax: 29,
    deliveryFee: 40,
  ...
  },
  {
    ...
    items: [
      ...
      { id: 2, name: "Idli Sambar", quantity: 1, price: 150 },
      { id: 3, name: "Filter Coffee", quantity: 2, price: 80 },
    ],
    subtotal: 470,
    tax: 24,
    deliveryFee: 30,
