...
const dishesData = [
  ...
  { name: "Kumbh (Mushroom) Paneer Masala", price: 220, category: "paneer-specialties", description: "Cottage cheese with mushrooms", isVeg: true },
  ...
  { name: "Mushroom Crispy", price: 110, category: "appetizers", description: "Crispy mushroom appetizer", isVeg: true, half: 110, full: 190 },
  ...
  { name: "Mushroom Chilly", price: 130, category: "appetizers", description: "Spicy mushroom starter", isVeg: true, half: 130, full: 200 },
...
async function seedDatabase() {
  try {
    ...
    console.log(`✅ Successfully seeded database with ${categoriesData.length} categories and ${dishesToInsert.length} dishes!`);
    
    // Log summary
    console.log("\n📊 Seeding Summary:");
    console.log(`Categories created: ${categoriesData.length}`);
    console.log(`Dishes created: ${dishesToInsert.length}`);
    console.log("\nCategories:");
    categoriesData.forEach(cat => console.log(`  - ${cat.name}`));
